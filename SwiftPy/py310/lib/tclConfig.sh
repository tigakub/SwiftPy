...
# installed.
TCL_PREFIX='/opt/homebrew/Caskroom/miniconda/base/envs/py310'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/opt/homebrew/Caskroom/miniconda/base/envs/py310'
...
TCL_EXTRA_CFLAGS='-ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /opt/homebrew/Caskroom/miniconda/base/envs/py310/include -fdebug-prefix-map=/var/folders/nz/j6p8yfhx1mv_0grj5xl4650h0000gp/T/abs_c011255d-355d-4e10-9d06-2a364b791019h2p45nxx/croots/recipe/tk_1654088770111/work=/usr/local/src/conda/tk-8.6.12 -fdebug-prefix-map=/opt/homebrew/Caskroom/miniconda/base/envs/py310=/usr/local/src/conda-prefix -pipe  -D_FORTIFY_SOURCE=2 -isystem /opt/homebrew/Caskroom/miniconda/base/envs/py310/include -mmacosx-version-min=11.1 '
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/opt/homebrew/Caskroom/miniconda/base/envs/py310/lib -L/opt/homebrew/Caskroom/miniconda/base/envs/py310/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/opt/homebrew/Caskroom/miniconda/base/envs/py310/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/opt/homebrew/Caskroom/miniconda/base/envs/py310/include'
...
TCL_PACKAGE_PATH='{/opt/homebrew/Caskroom/miniconda/base/envs/py310/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/opt/homebrew/Caskroom/miniconda/base/envs/py310/lib -ltclstub8.6'
...
TCL_STUB_LIB_PATH='/opt/homebrew/Caskroom/miniconda/base/envs/py310/lib/libtclstub8.6.a'
